...
*/
        ...
        var all_bars_width = one_bar_width * data.length;
        var bar_space = (width - all_bars_width) / (data.length * 2/* - 1*/);
        ...
        var label = enter.append("text")
            ...
            .attr("x", function(d) {
                ...
                var x = (one_bar_width - this.getBBox().width) / 2
    ...
    draw_y_axis : function(orientation)
    {
        ...
        else
        {
            ...
            var transform = 'translate(' + (this.props.width) + ', ' + 0/*(berth + 1)*/ + ')';
        }
/*
        if (this.element) {
...
*/
    ...
    draw_grid : function(axis) {
        ...
        var gridSize = this.props.width - 30;
        ...
        if (!this.grid_inited)
        {
            ...
            this.chart
                ...
                .attr("transform", function(d) {
                    return "translate(" + (self.props.width - 10) + "," + 0 + ")"; // todo: x position
                })
    ...
    render : function(){
        ...
        var style = {
            width : this.props.width + 104 // todo
        }
