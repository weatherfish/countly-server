...
var GraphWrapper = React.createClass({
    ...
    getInitialState() {
        ...
        if (granularity_rows[0].mode == "ghost") // todo: fix for previous time ranges
        {
...
*/
    ...
    render() {
        ...
        var graph_style = {
            "width"       : (this.props.width/* - 20*/) + "px", // todo
            "height"      : this.props.height + "px",
            "margin-left" : (this.props.margin_left/* + 20*/) + "px"
        }
        ...
        {
            var blocks = JSON.parse(JSON.stringify(this.state.lines_descriptions));
                ...
                {(() => {
                    ...
                    if (blocks){
                      ...
                      return (<div className="color_description">
                          {
                              _.map(blocks, function(description, i) {
